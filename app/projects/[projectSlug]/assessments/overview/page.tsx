...
export default function ProjectAssessmentsOverviewPage(): ReactElement {
  return <ProjectAssessmentsOverviewPageContent />;
}

async function ProjectAssessmentsOverviewPageContent(): Promise<ReactElement> {
